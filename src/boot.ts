...
class Boot {
	...
	constructor() {
		this.game = new Phaser.Game(400, 600, Phaser.AUTO, "gameContainer", { preload: this.preload, init: this.init, create: this.create });
	}
	...
	init() {
		...
		if (this.game.device.desktop) {
            ...
            this.game.scale.setMinMax(400, 600, 800, 1200);
